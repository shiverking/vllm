...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_QWEN3_ASR_REALTIME_VAD_ONNX": lambda: bool(
        int(os.getenv("VLLM_QWEN3_ASR_REALTIME_VAD_ONNX", "0"))
    ),
    ...
    "VLLM_QWEN3_ASR_REALTIME_VAD_SPEECH_PAD_MS": lambda: int(
        os.getenv("VLLM_QWEN3_ASR_REALTIME_VAD_SPEECH_PAD_MS", "0")
    ),
...
def compile_factors() -> dict[str, object]:
    ...
    ignored_factors: set[str] = {
        ...
        "VLLM_QWEN3_ASR_REALTIME_VAD_ONNX",
